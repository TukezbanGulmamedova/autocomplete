...
input.addEventListener("input", () =>{
  setTimeout(() =>{
    ...
    results = [...new Set (availableKeywords.filter((keyword) => keyword.toLocaleLowerCase().includes(givenValue)))];
    ...
    results.forEach((result) =>{
      ...
      liElement.className = "text-slate-700 rounded-md p-4 cursor-pointer hover:bg-slate-200 transition-allduration-200"
